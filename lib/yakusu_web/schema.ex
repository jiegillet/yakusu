defmodule YakusuWeb.Schema do
  use Absinthe.Schema
  import_types(YakusuWeb.Schema.BooksTypes)
  import_types(YakusuWeb.Schema.LanguagesTypes)
  ...
  query do
    ...
    @desc "Export a rendered translation book"
    field :render_book, non_null(:string) do
      arg(:id, non_null(:id))
      arg(:max_characters, non_null(:integer))
      resolve(&Resolvers.Books.render_translation_book/3)
    end
